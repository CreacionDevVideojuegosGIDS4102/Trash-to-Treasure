...
public class MovementController : MonoBehaviour
{
    ...
    public void UpdateOrganicWasteCounter()
    {
        ...
        {
            organicWasteCounterText.text = "Recolectada: " + organicWasteCollected + "/" + LevelController.Instance.organicWasteToNextLevel;
        }
    }
    ...
    public void CollectOrganicWaste()
    {
        ...
        if (organicWasteCollected >= LevelController.Instance.organicWasteToNextLevel)
        {
            LevelController.Instance.AdvanceToNextLevel(); // Avanza al siguiente nivel
        }
    ...
    {
        playerLife = Mathf.Min(playerLife + amount, 100);
        UpdateHealthBar();
    }
}
*/